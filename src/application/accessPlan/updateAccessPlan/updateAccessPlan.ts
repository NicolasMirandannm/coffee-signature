...
export default class UpdateAccessPlan implements IUpdateAccessPlan {
    ...
    async execute(id: string, accessPlanDto: AccessPlanDto): Promise<AccessPlan> {
        ...
        ApplicationException.whenParameterIsNull(accessPlanExists, 'accessPlan does not exists.');
        ...
        }, UniqueIdentifier.create(accessPlanExists.getProps().receiver.getId().value));
